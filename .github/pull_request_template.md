...
- [ ] I have updated the semver version (dice.version)

## License

I am contributing & releasing the code under the [MIT License](https://github.com/SixofClubsss/dDice/blob/main/dice/LICENSE).